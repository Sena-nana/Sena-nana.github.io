...
B2 Pre-Released 未修改完成版本,B1版见一版规则书对应文件
...
初中时，如月也曾是普通的女孩子。她和其他人一样，“融入”了班上女孩子的小圈子。但是，小圈子中出现了一些矛盾，为了转移这些矛盾，领头人将过错抛给了当时就有些内向的她。一瞬间，她曾经相信的朋友就开始视她为异己。她开始被欺凌，虽然并不是很过分，并且立即被家长和老师发现。于是她立即转学到了老家的学校。在新的学校，她害怕融入任何的圈子。她变得越来越内向，却又无比羡慕着有着朋友的人。于是，在成为高中生的时候，**想要有人可以一起上下学，想要有人可以分享一切，想要一个真正的朋友**，这么想着，QB 回应了她。
...
- **月台** 的结构非常简单，仅有几个长椅，一个站牌，数盏路灯便空无他物。而车站的四周是无比空旷的荒野，更远处则被浓雾所遮盖。
  ...
  - 当玩家们想要穿越**浓雾**时，相离超过2m的玩家就会互相看不到对方，只能通过声音确定对方的大致方向。
  ...
  - **手机** 手机的所有界面都一直在抖动，所有文字都模糊不清，屏幕时而变色时而出现条纹。玩家会明显感觉继续看下去会有不好的事情发生，但是手机的其中一个应用有一个异常引人注目的小红点。当玩家尝试点开时，所有看着屏幕的玩家对于一车厢的观察会被回忆·一车厢的场景强制替换，并因为辨认扭曲怪异的界面而损失 1/1D3 的 SAN 值。少女会随着玩家一起进入回忆中。
    ...
    - **支线：采购** 
      - **手机** 在进入回忆后，手机上弹出了一个广告：
        - >Miss'Crepes一周年酬宾！凭此优惠券可免费领取特制限定可丽饼一份！
        - Miss'Crepes是这个小镇真实存在的一家店，在商店街附近，生意火爆
      - **甜品店** 甜品店的店员外貌并不重要，可以随意描述。店员会正常与玩家交流，店员的RP请参考现实中店员的营业状态。
        ...
        - 当玩家把材料带来后，她会送给回忆中的玩家每人一个**可丽饼**。并会额外递给少女一个可丽饼让她带给’今天没有来的那个孩子’（即如月），如果少女不在则不会给额外的可丽饼。
          ...
          - 当与崩坏化身战斗时，额外的可丽饼当玩家拿出来时，会在一阵闪光后消失，整个环境仿佛被静止一样，只有玩家可以行动，在一个战斗轮后恢复，在崩坏化身的回合内同样可以使用。
...
列车二车厢看上去像是一间教室，比列车本身应有的大小要大很多。但是窗外仍是之前的景象。教室内仅在靠窗的角落有两个桌椅，其中一个的桌面上端正地摆着一束白百合，另外一个座位是空的。教室的后面有学生用储物柜和用于放置扫除用具的柜子。从教室的后门离开就会到达列车的三车厢
...
- **黑板**上写着“祝贺毕业”，但是被擦掉了只剩下痕迹。
- **储物柜**的柜子都上着锁，仅有座位后面的柜子半掩着。里面是一个日记本
- 玩家会感觉花上有异常的魔力波动，需要玩家主动进行共鸣。检定成功后，会看到回忆中的二车厢。
- **回忆·二车厢**中光线变得灰暗。两个桌椅只剩下了空的那一个。而带花的那个，椅子则被倒扣在桌子上。推到了角落
  - 黑板和桌面上写满了“杀人犯”之类的字眼
  - 探索成功时，会发现黑板上有一行小字：“我只是想抱住她。.”，之后手机弹出消息提示，点开后，会有无数的“对不起”从屏幕中冒出来，直到填满整个房间将教室淹没。处在回忆中的少女需要进行体质检定，失败会因为窒息而损失 0/1D2 的 SAN 值。
  - 当玩家探索失败或者被淹没后，回忆消失。
## 第四部分：列车三车厢
列车三车厢看起来则像是一个女孩子的卧室。
**回忆·三车厢**中
...
崩坏化身看起来就像普通的少女，但是其身着像是红色的冰制成的服装，任何的行动都会导致服装破裂并划破自身，然后迅速痊愈生成新的服装。（这个特性不会损失 HP，只是用来丰富形象的）
...
| 戒备心   | 70     | 受到近身攻击时触发技能，衣服上的尖刺会使对方收到 1D4 的伤害，该攻击视作反击行为，无法通过被动行动应对 |
| 尖刺陷阱 | 50     | 从地面上穿出无数长枪破坏掉一切，对身边的魔法少女和物体造成武器1D5的穿刺伤害                           |
| 穿刺     | 70     | 将长枪向对方甩出。对命中的魔法少女造成1D8的穿刺伤害                                                   |
