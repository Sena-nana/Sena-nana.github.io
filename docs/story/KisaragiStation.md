...
- **轨道** 月台下的轨道乍一看没有什么异常，但如果**侦查**检定成功，会发现轨道上有着淡淡的、快要消失的血迹。
  - 当灵感检定成功时，玩家会感到一阵恍惚，耳边似乎听到一阵哀鸣：“不要、不要遗忘我、不要丢下我......”,并会损失0/1D3的SAN值。
...
- **行李箱** 行李箱的密码是915，当然也可以通过暴力打开。当玩家打开行李箱时，整个车厢突然会堆满相片，而行李箱中是一个手机。
    ...
    - **手机** 手机的所有界面都一直在抖动，所有文字都模糊不清，屏幕时而变色时而出现条纹。玩家会明显感觉继续看下去会有不好的事情发生，但是能察觉到手机上有明显的魔力波动。当玩家选择继续观看的时候，所有看着屏幕的玩家对于一车厢的观察会被回忆·一车厢的场景强制替换，并因为辨认扭曲怪异的界面而损失1/1D3的SAN值。
        - **回忆·一车厢** 回忆中的车厢看起来像是一个商业街的小巷，座椅被商业街的座椅替换，而车厢则变成了墙壁。座椅上坐着两位少女正在贴贴的幻象，然而代表莲实的少女扭曲程度比之照片上有过之而无不及。二车厢另一边的车门，此时变成了一个甜品店。手机上的文字也可以辨认了。
            - **少女** 当少女看到贴贴场景时，会突然泪流满面，并会下意识呼唤“如月”之类的字眼，而且仍然意识不到原因。
            ...
            - **甜品店** 甜品店的店员外貌并不重要，可以随意描述。店员会正常与玩家交流，但是内容都是建立在现实中的甜品店基础上的。不过根据玩家问的问题还是会有一些特殊的回答作为线索：
                ...
                - “她们两个可是这里的常客”或者类似的回答，作为提示让玩家帮助莲实回忆自己。
            - 当玩家想要离开甜品点时，回忆就会消失回到一车厢的景象，手机会黑屏
- **少女** 少女不记得自己是谁，也不知道这里是哪里。但是会哀求玩家，让玩家帮她想起自己是谁，并声称如果她想不起自己的身份，将会有不好的事情发生。在玩家打开车门后，会请求跟随玩家一起行动。当玩家获得关键线索时，少女会下意识有所反应，具体根据主持人的想法来自由发挥。
...
- 回忆·二车厢中是如月初中时的教室，整体装饰发生了变化，且光线变得灰暗。两个桌椅只剩下了空的那一个。
    - 黑板和桌面上写满了“杀人犯”之类的字眼
    - 探索成功时，会发现黑板上有一行小字：“我只是想她...”，然后手机收到消息，点开后，会有无数的“对不起”从屏幕中冒出来，直到填满整个房间将教室淹没。处在回忆中的少女需要进行体质检定，失败会因为窒息而损失0/1D2的SAN值。
    - 当玩家探索失败或者被淹没后，回忆消失。
